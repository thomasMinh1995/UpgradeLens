...
The GitHub repository has not yet been renamed. Current repository, issue, and
private security links continue to use the live
`thomasMinh1995/UpgradeLens` repository until the maintainer completes and verifies
the manual rename.
...
- the GitHub repository rename and npm preview publication are separate pending
  gates.

## Community and private reporting

- Security: use the verified GitHub Private Vulnerability Reporting route in
  [SECURITY.md](../../SECURITY.md). Its current repository URL remains live until
  the rename.
