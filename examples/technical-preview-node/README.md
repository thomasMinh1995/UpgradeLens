...
This public-safe sample gives DepVerdict one ordinary Node dependency occurrence:
...
From the current repository root, first inspect deterministic discovery without
...
`.depverdict/` or `.upgradelens/` artifacts to this sample.
